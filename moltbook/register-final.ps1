...
try {
    ...
    # 保存到文件
    Out-File -InputObject $content -FilePath "moltbook\SuperDamonV2-register.json" -Encoding UTF8
    Write-Host "`n`n响应已保存到 moltbook\SuperDamonV2-register.json" -ForegroundColor Cyan
} catch {
