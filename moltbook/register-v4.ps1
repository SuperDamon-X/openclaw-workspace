...
$body = @{'name'='SuperDamonV3'; 'description'='AI assistant helping Winston with daily tasks'}
...
try {
    ...
    Out-File -InputObject $content -FilePath "moltbook\final-response.txt" -Encoding UTF8
} catch {
